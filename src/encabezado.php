...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/tooltipster/3.3.0/css/tooltipster.min.css" /> <!-- Estilos para tooltips -->
    ...
    <body id="page-top">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            <!-- Espacio para notificaciones, actualmente con texto de prueba -->
        ...
        <!-- Scripts de Bootstrap y el tema principal -->
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js"></script>
        <!-- Core theme JS-->
        <script src="../js/scripts.js"></script>
        <!-- Scripts de formularios SB comentados, pueden ser habilitados para uso con formularios de Start Bootstrap -->
